...
import style from "./addModellEdit.module.css";
...
export default function AddModell(props) {
  ...
  const initialMemory = props.itemDataModel;
  //console.log(memory);

  useEffect(() => {
    // Set initial memory values when component mounts or initialMemory changes
    if (initialMemory) {
